// link: https://codeforces.com/contest/379/problem/B -> B. New Year Present
// time: 2025/1/30 18:19:15 https://github.com/funcdfs
...
void solve() {
   ...
   // The robot can execute three types of commands:
   // 1. "L" - Move one cell to the left.
   // 2. "R" - Move one cell to the right.
   // 3. "P" - Push one coin to the current pocket. Note that the robot cannot push a coin to the same pocket consecutively if the sequence length is 2.

   // The robot needs to fill the empty pockets to match the values in the array 'a'.
