// link: https://codeforces.com/contest/1833/problem/A -> A. Musical Puzzle
// time: 2025/2/3 12:17:37 https://github.com/funcdfs
...
auto solve(int _case) -> void {
   ...
   // exist how many [partlen == 2] substr

   set<string> hs;
   for (int i = 0; i < n-1; i++) {
      hs.insert(s.substr(i, 2));
   }
