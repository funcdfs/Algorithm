// link: https://codeforces.com/contest/1702/problem/D -> D. Not a Cheap String
// time: 2025/2/2 19:56:38 https://github.com/funcdfs
...
auto solve(int _case) -> void {
   ...
   // the price is: sum (int(w[i]-'a'))
   // delete the minimum count of char, make the string price <= p

   string s = w;
   sort(s.begin(), s.end(), [](const auto& x1, const auto& x2) {
      return x1 > x2;
   });
   int tot = 0;
   for (auto c : s) {
