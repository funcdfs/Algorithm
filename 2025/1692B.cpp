// link: https://codeforces.com/contest/1692/problem/B -> B. All Distinct
// time: 2025/2/19 13:32:27 https://github.com/funcdfs
...
auto solve(int _case) -> void {
   ...
   if (need % 2 == 1) {
      cout << n-  2*(need / 2 + 1) << endl;
   } else {
      cout << n- 2*(need / 2) << endl;
   }
