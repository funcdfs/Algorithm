// link: https://codeforces.com/contest/1702/problem/B -> B. Polycarp Writes a String from Memory
// time: 2025/2/2 19:08:26 https://github.com/funcdfs
...
auto solve(int _case) -> void {
   ...
   for (int i = 0; i < ssize(s); i++) {
      if (ssize(hs) == 3 && hs.contains(s[i]) == false) {
         hs.clear();
         ans += 1;
      }
      hs.insert(s[i]);
