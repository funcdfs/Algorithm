// link: https://codeforces.com/contest/1811/problem/B -> B. Conveyor Belts
// time: 2025/2/12 14:39:08 https://github.com/funcdfs
...
auto solve(int _case) -> void {
   ...
   // for each testcase, output the minimum cost to move the object from (x1, y1) to (x2, y2)
   ...
   int cost = abs(levelStart - levelEnd);
   cout << cost << endl;
