// link: https://codeforces.com/contest/1203/problem/A -> A. Circle of Students
// time: 2025/2/14 17:35:50 https://github.com/funcdfs
...
auto solve(int _case) -> void {
   ...
   auto check = [&]() -> bool {
      // for (int i = 0; i < n; i++) rotate(1), check is_sorted or reverse is_sorted
      bool clock = true;
      bool revClock = true;
      int posOne = find_if(a.begin(), a.end(), [=](const auto& xx){
         return xx == 1;
      }) - a.begin();
      for (int i = 2; i <= n; i++) {
         if (i != a[(posOne+i-1)%n]) {
