// link: https://atcoder.jp/contests/abc342/tasks/abc342_a A - Yay!
// time: 2024/10/11 13:18:11 https://github.com/funcdfs
...
void solve() {
   ...
   for (auto& [k, v] : hs) {
      if (v == 1) {
         auto it = find_if(s.begin(), s.end(), [=](const auto& xx){
            return xx == k;
         });
