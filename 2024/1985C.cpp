// link: https://codeforces.com/contest/1985/problem/C C. Good Prefixes
// time: 2024/9/21 13:02:36 https://github.com/funcdfs
...
auto solve(int _case) -> void {
   ...
   // the count of preSum == other sum, 
   // all the subarray count 

   // if exist one num == other's sum, this array call good 
   ...
   for (int i = 0; i < n; i++) {
      ...
      // if a num == all other's sum, this num is largest
      // Sum == maxVal + [other's sum] == maxVal *2 
      if (maxVal*2 == sum) {
         ans += 1;
      }
   }
