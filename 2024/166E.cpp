// link: https://codeforces.com/contest/166/problem/E E. Tetrahedron
// time: 2024/6/30 22:33:26 https://github.com/funcdfs
...
auto solve() -> void {
   ...
   /*
   f[i][j] 在第 i 步时，位于顶点 j 的路径的数量
      f[0][3] == 1 f[0][0], f[0][1], f[0][2] == 0
    */
