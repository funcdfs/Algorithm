// link: https://codeforces.com/contest/1846/problem/D D. Rudolph and Christmas Tree
// time: 2024/6/25 18:04:30 https://github.com/funcdfs
...
func solve(_case int) { // log.Println("# CASE: ", _case)
	...
	n, d, h := input[int](), input[int](), input[int]()
	y := inputSlice[int](n) 
