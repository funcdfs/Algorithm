// link: https://codeforces.com/contest/228/problem/A A. Is your horseshoe on the other hoof?
// time: 2024/9/17 18:46:43 https://github.com/funcdfs
...
auto solve() -> void {
   ...
   int cnt = set<int>(a.begin(), a.end()).size();
   println(4-cnt);
