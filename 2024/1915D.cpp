// link: https://codeforces.com/contest/1915/problem/D D. Unnatural Language Processing
// time: 2024/9/22 14:15:29 https://github.com/funcdfs
...
auto solve(int _case) -> void {
   ...
   while (p < n) {
      if (s[p] == 'a' || s[p] == 'e') {
         ...
         p += 2;
         // reverse(CV)
         // The difference between the two syllables lies in their different suffixes.
      } else {
         ans += s.substr(p, 3);
         p += 3;
         // reverse(CVC)
