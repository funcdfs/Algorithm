// link: https://codeforces.com/contest/1760/problem/C C. Advantage
// time: 2024/9/17 12:12:03 https://github.com/funcdfs
...
auto solve(int _case) -> void {
   ...
   auto s = a;
   sort(s.begin(), s.end());
   int maxVal = s.rbegin()[0];
   int secondMaxVal = s.rbegin()[1];
