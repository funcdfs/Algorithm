// link: https://codeforces.com/contest/1375/problem/B B. Neighbor Grid
// time: 2024/6/29 12:01:26 https://github.com/funcdfs
...
auto solve(int _case) -> void {
   ...
   for (int i = 0; i < n; i++){
      for (int j = 0; j < m; j++) {
         ...
         g[i][j] = adj; // 2 3 3 2 | 3 4 4 3 | 3 4 4 3 | 2 3 3 2
      }
   }
